...
在桌面端更新入口进行系统版本更新过程中，更新进度一直卡在 70% 无法完成更新，故所有测试仅基于更新了软件包的基础上，未对该镜像所装系统进行更新，可能存在一定版本落后问题
...
看上去是出现了日志时间回滚、日志占用现象

**问题处理记录**

考虑可能是因为板卡内存较小，所设置的 swap 文件较大，导致磁盘资源紧张，从而出现了日志占用、打不开桌面端的问题
